...
Public Class F_ISSUE
    ...
    Private Sub F_ISSUE_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        F_Main.lbl_Display.Text = Me.Tag.MenuName2
    End Sub
    Private Sub F_ISSUE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
#Region "Implements"
    ...
    Public Sub Load_MAS() Implements CL_interface.DefultFoundation.Load_MAS
        Try
            ...
            If ret.Respon.Result And ret.Data IsNot Nothing Then
...
#Region "Method"
    ...
    Private Sub SearchItems()
        ...
        Try
            ...
            Grid_column.Add(New F_SearchData.GridColumn With {.Columntext = "จำนวนคงเหลือ", .ColumnName = "value1"})
            Grid_column.Add(New F_SearchData.GridColumn With {.Columntext = "หน่วย", .ColumnName = "value2", .visible = False})
            Grid_column.Add(New F_SearchData.GridColumn With {.Columntext = "หน่วย", .ColumnName = "value3"})

            Dim f As New F_SearchData With {
                                                .Multiselect = True,
                                                .Frm_text = "ค้นหาสินค้า",
                                                .SCR_TYPE = "STOCK",
                                                .fixvalue = "",
            ...
            If (f.ShowDialog) = DialogResult.OK Then
                ...
                For Each Val As DataGridViewRow In f.dgv_scr.SelectedRows
                    If Not check_items(Val.Cells("CODE").Value) Then
                        Continue For
                    End If
                    ...
                    With Me.DgvItems.Rows(currow)
                        ...
                        .Cells("PCODE").Value = Val.Cells("CODE").Value
                        .Cells("PNAME").Value = Val.Cells("NAME").Value
                        .Cells("QTY").Value = 1
                        .Cells("ST_QTY").Value = 1
                        .Cells("ST_QTY2").Value = 1


                        .Cells("UNIT_COST").Value = 0
                        .Cells("TOTAL_COST").Value = 0


                        .Cells("UNITCODE").Value = Val.Cells("value2").Value
                        .Cells("UNITNAME").Value = Val.Cells("value3").Value
                        .Cells("ST_UNITCODE").Value = Val.Cells("value2").Value
                        .Cells("ST_UNITNAME").Value = Val.Cells("value3").Value
