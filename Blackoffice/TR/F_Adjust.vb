...
#Region "Event"
    Public Sub SetEvent() Implements CL_interface.DefultFoundation.SetEvent
        ...
        AddHandler Me.btn_scr_reason.Click, AddressOf EV_Btn_Click
        AddHandler Me.btn_clear_reason.Click, AddressOf EV_Btn_Click
    ...
    Private Sub EV_DGV_CellValueChanged(sender As Object, e As DataGridViewCellEventArgs)
        ...
        Try
            ...
            Select Case sender.Columns(e.ColumnIndex).Name
                ...
                Case "IDC"
                    With sender.Rows(e.RowIndex)
                        If .Cells("IDC").Value = "0" Then
                            .Cells("IDC").Style.ForeColor = Color.Black
                        ElseIf .Cells("IDC").Value = "1" Then
                            .Cells("IDC").Style.ForeColor = T_Color.Grid_Cell_UP
                        ElseIf .Cells("IDC").Value = "-1" Then
                            .Cells("IDC").Style.ForeColor = T_Color.Grid_Cell_Down
                        End If

                    End With
                    sumTotal()

                    DgvItems.Rows(0).Cells("df").Style.BackColor = Color.Red
            End Select
    ...
    Private Sub EV_Btn_Click(sender As Object, e As EventArgs)
        Try
            Select Case sender.name
                Case btn_scr_reason.Name
                    SearchJ_Reason()
                Case btn_clear_reason.Name
                    REASON.Clear()
...
#Region "Implements"
    ...
    Public Sub Load_Data(value1 As String, value2 As String, value3 As Object) Implements CL_interface.DefultFoundation.Load_Data
        ...
        Try
            ...
            If ret.Respon.Result Then
                ...
                'Me.TOTALUP_QTY.Text = data.Data_H.TOTAL_QTY
                ...
                Me.REASON.Text = data.Data_H.REMARK2
    ...
    Public Sub Gencolumn() Implements CL_interface.DefultFoundation.Gencolumn
        ...
        cbo.HeaderText = "จำนวนเพิ่ม/ลด"
        cbo.Width = 100
        cbo.Visible = True
        cbo.ReadOnly = False
        cbo.DataPropertyName = "IDC"
        cbo.Name = "IDC"
        cbo.DataSource = Tmp_Data.MOV_IDC
        cbo.DisplayMember = "name"
        cbo.ValueMember = "value"
        cbo.FlatStyle = FlatStyle.Flat
        cbo.DefaultCellStyle.BackColor = T_Color.Grid_Cell_Edit
        Me.DgvItems.Columns.Add(cbo)
        ...
        Col = New DataGridViewTextBoxColumn
        Col.HeaderText = "ต้นทุนต่อหน่วย(มาตรฐาน)"
        Col.Width = 150
        Col.Visible = False
        Col.ReadOnly = read
    ...
    Public Function Checkdata() As Boolean Implements CL_interface.DefultFoundation.Checkdata
        ...
        If Me.REASON.Text = "" Then
            msg &= vbNewLine & "- กรุณาเลือกเหตุผล"
        End If


        For Each grow As DataGridViewRow In Me.DgvItems.Rows


            If grow.Cells("IDC").Value = "0" Or grow.Cells("IDC").Value Is Nothing Then
                msg &= vbNewLine & "- รายการที่ " & grow.Cells("SEQ").Value & " ไม่ได้เลือกจำนวนเพิ่ม/ลด"
            End If
        Next
    ...
    Public Function FSave(Optional obj As Object = Nothing) As CL_interface.Answer Implements CL_interface.DefultFoundation.FSave
        Try
            ...
            Dim link As String = String.Format(Center.Post_API.TR_Movment_Save, UI_STAT)
...
#Region "SAVE"
    Private Function Save_H() As Boolean
        ...
        data.Data_H.TOTAL_QTY = TOTALUP_QTY.Text
        ...
        data.Data_H.REMARK2 = REASON.Text
        data.Data_H.REMARK3 = ""
        data.Data_H.REMARK4 = ""
        data.Data_H.REMARK5 = ""
...
#Region "Method"
    Private Sub sumTotal()
        Dim qty_up As Double = 0
        Dim qty_down As Double = 0
        Dim amount As Double = 0
        For Each drow As DataGridViewRow In Me.DgvItems.Rows
            If CDbl(drow.Cells("IDC").Value) = 1 Then
                qty_up += CDbl(drow.Cells("QTY").Value)
            ElseIf CDbl(drow.Cells("IDC").Value) = -1 Then
                qty_down += CDbl(drow.Cells("QTY").Value)
            End If
            amount += CDbl(drow.Cells("TOTAL_COST").Value)
        Next

        Me.TOTALUP_QTY.Text = qty_up
        Me.TOTALDOWN_QTY.Text = qty_down
    ...
    Private Sub SearchJ_Reason()
        ...
        Try
            ...
            Dim f As New F_SearchData With {
                                                .Multiselect = True,
                                                .Frm_text = "ค้นหาเหตุผล",
                                                .SCR_TYPE = "REASON",
                                                .fixvalue = "",
                                                .lbl_CODE_text = "รหัสเหตุผล",
                                                .lbl_NAME_text = "ชื่อเหตุผล",
                                                .grid_code_text = "รหัสเหตุผล",
                                                .grid_name_text = "ชื่อเหตุผล",
                                                .Grid_column = Grid_column
                                            }
            f.Icon = Center.icon
            ...
            If (f.ShowDialog) = DialogResult.OK Then
                ...
                For Each Val As DataGridViewRow In f.dgv_scr.SelectedRows
                    If REASON.Text = "" Then
                        REASON.Text = Val.Cells("NAME").Value
                    Else
                        REASON.Text += "  ,  " & Val.Cells("NAME").Value
                    End If
