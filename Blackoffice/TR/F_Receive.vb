...
a:
                    ...
                    Else
                        With sender.Rows(e.RowIndex)
                            ...
                            .Cells("UNIT_COST").Value = CDbl(.Cells("ST_COST").Value) * CDbl(.Cells("ST_QTY2").Value)
                            .Cells("TOTAL_COST").Value = CDbl(.Cells("ST_COST").Value) * CDbl(.Cells("ST_QTY").Value)
                        End With
...
#Region "Implements"
    ...
    Public Sub Gencolumn() Implements CL_interface.DefultFoundation.Gencolumn
        ...
        Col = New DataGridViewTextBoxColumn
        Col.HeaderText = "ต้นทุนต่อหน่วยรอง"
        Col.Width = 150
        Col.Visible = True
        Col.ReadOnly = read
        ...
        Col = New DataGridViewTextBoxColumn
        Col.HeaderText = "ต้นทุนต่อหน่วย"
        Col.Width = 150
        Col.Visible = True
        Col.ReadOnly = False
        Col.DataPropertyName = "ST_COST"
        Col.DefaultCellStyle.BackColor = T_Color.Grid_Cell_Edit
        Col.Name = "ST_COST"
        Me.DgvItems.Columns.Add(Col)
...
#Region "SAVE"
    ...
    Private Function Save_items() As Boolean
        ...
        For Each drow As DataGridViewRow In Me.DgvItems.Rows
            ...
            val.ST_COST = drow.Cells("ST_COST").Value
            ...
            If (f.ShowDialog) = DialogResult.OK Then
                ...
                For Each Val As DataGridViewRow In f.dgv_scr.SelectedRows
                    ...
                    With Me.DgvItems.Rows(currow)
                        ...
                        .Cells("ST_COST").Value = Val.Cells("COST_STD").Value
            ...
            If (f.ShowDialog) = DialogResult.OK Then
                ...
                For Each Val As DataGridViewRow In f.dgv_scr.SelectedRows
                    With Me.DgvItems.CurrentRow
                        ...
                        .Cells("ST_COST").Value = CDbl(.Cells("UNIT_COST").Value)
                        .Cells("UNIT_COST").Value = CDbl(.Cells("ST_COST").Value) * CDbl(.Cells("ST_QTY2").Value)
