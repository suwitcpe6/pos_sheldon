...
Public Class F_YearEnd_List
    ...
    End Sub
    Private Sub F_YearEnd_List_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Timer1.Enabled = True
    End Sub
#Region "Event"
