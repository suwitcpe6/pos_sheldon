...
#End Region
    ...
    Public Function FPrint(Optional obj As Object = Nothing) As CL_interface.Answer Implements CL_interface.DefultFoundation.FPrint
        Try
            ...
            Dim fill_data As New RPT_BalanceModels.Fillter_Balance
            ...
            Dim link As String = String.Format(Center.Post_API.RPT_Balance, UI_STAT)
            Dim json_Response As String = New API(Center.Data_Config.API_SRV, API.set_Timeout.Min_5).POSTResponse(link, json, "POST")
            Dim retValue As RPT_BalanceModels.value = JsonConvert.DeserializeObject(Of RPT_BalanceModels.value)(json_Response)
            ...
            If retValue.Respon.Result Then
                ...
                Dim rpt_path As String = Center.Default_Path_RPT & "RPT_Balance.rdlc"
