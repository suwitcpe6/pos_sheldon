...
Public Class CL_date
    ...
    Public Shared Function Condate(ByVal val As Date, format_ As String, ByVal Optional dateType As String = "ENG") As String

        'Dim dte As Date = dtst.Value
        ...
        Else
            ...
            End If
        End If
        'date_ = CDate(date_).ToString(format_, ThaiCulture.DateTimeFormat)
